...
$pdf->SetFont('HELVETICA','B',9);
$pdf->SetX(20);
$pdf->Cell(180,10 , utf8_decode(' Situacion reportada:   '.  $row['situacion_reportada']) ,1,1);
$pdf->Ln(10);
$pdf->SetX(20);
$pdf->Cell(180,10 , utf8_decode(' situación observada:   '.  $row['situacion_obserbada']) ,1,0);
$pdf->Ln(15);
$pdf->SetX(20);
$pdf->Cell(180, 10 , utf8_decode('labor realizada: '. $row['descripcion'])  ,1,1);
$pdf->Ln(10);
$pdf->SetX(20);
