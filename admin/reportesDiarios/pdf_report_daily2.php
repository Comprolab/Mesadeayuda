...
hrd.cliente,
hc.nombre
FROM hesk_registros_diarios hrd LEFT JOIN hesk_customers hc ON hrd.cliente = hc.id WHERE (fecha BETWEEN '$_POST[fechaReporte]' AND '$_POST[fechaReporte2]') AND hrd.nombreTecnico LIKE '%$_POST[consTecnico]%'");
