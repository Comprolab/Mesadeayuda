            ...
            <div class="navbar__menu-wrap">
                <ul class="navbar__list">
                        ...
                        <li class="listitem submenu <?php echo $open_menu; ?>">
                            <div class="listitem__icon">
                                <a class="icon icon-settings" href="#">
                                    ...
                                    <i class="fas fa-map-marker-alt fa-2x icon icon-settings"></i>
                                    <svg class="icon icon-settings">
                    ...
                    <li class="listitem mobile <?php if ($calling_script === 'mail') { ?>current<?php } ?>">
                        <div class="listitem__icon">
                            <a href="mail.php" style="display: flex;">
            ...
            <div class="header__right" style="border-left: none">
                ...
                <div class="profile">
                    <div class="profile__item profile__item--mail">
                        <a href="mail.php" style="display: flex;" class="btn btn-empty tooltip" title="<?php echo $hesklang['m_h']; ?>">
