        ...
        <main class="main">
            <div class="reg__wrap">
                ...
                <div class="reg__section">
                    ...
                    <div class="reg__box">
                        <h2 class="reg__heading" style="text-align: center;">Mesa de ayuda comprolab</h2>
                        <h2 class="reg__heading" style="text-align: center;"><?php echo $hesklang['admin_login']; ?></h2>
                        ...
                        <form action="index.php" class="form <?php echo isset($_SESSION['a_iserror']) && count($_SESSION['a_iserror']) ? 'invalid' : ''; ?>" id="form1" method="post" name="form1" novalidate>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    $class .= '"';
                                    ?>
                                    <input type="password" name="pass" id="regInputPassword" <?php echo $class; ?> <?php if (defined('HESK_DEMO')) {
                                                                                                                        echo ' value="demo1"';
                                                                                                                    } ?>>
                                    <div class="input-group-append--icon passwordIsHidden" onclick="mostrarContrasena();">
                                    ...
                                    <script>
                                        function mostrarContrasena() {
                                            var tipo = document.getElementById("regInputPassword");
